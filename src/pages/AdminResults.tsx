        ...
        {results.length === 0 ? (
          ...
          <div className="space-y-8">
            {results.map((positionResult) => {
              // Custom winner rule: 
              // - Vocal: 4 winners (top 4 in votes)
              // - Presidente/Secretaria/Asesor: 1 winner (top 1)
                      ...
                      <>
                        ...
                        <div className="space-y-4">
                          ...
                          {positionResult.resultados.map((result, index) => {
                            // Candidate is winner if their index is less than the maxWinners and they have at least 1 vote
